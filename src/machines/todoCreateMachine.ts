import { crtTodos } from "@/api";
import { createMachine, assign, InterpreterFrom } from "xstate";

export const TODOCREATE_EVENT_COMP_CHANGED = "todocreate.event.comp_changed";
export const TODOCREATE_EVENT_TEXT_CHANGED = "todocreate.event.text_changed";
export const TODOCREATE_EVENT_FORM_SUBMITED = "todocreate.event.form_submited";
export const TODOCREATE_EVENT_BACK = "todocreate.event.back";

export const TODOCREATE_STATE_INITIAL = "todocreatestateinit";
export const TODOCREATE_STATE_SUBMITTING = "todocreatestatesubmitting";
...
export type Events =
    ...
    export type Services = {
      submitFormService: { data: unknown };
    }
...
export const todoCreateMachine = createMachine(
			...
			[TODOCREATE_STATE_INITIAL]: {
				on: {
					...
					[TODOCREATE_EVENT_FORM_SUBMITED]: {
						target: TODOCREATE_STATE_SUBMITTING,
					},
    ...
    services: {
      submitFormService: async (context) => await crtTodos({ text: context.text, completed: context.checked })
    }
	},
);
